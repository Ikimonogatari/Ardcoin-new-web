...
export default function Home() {
  return (
    <main className="w-full h-screen relative flex justify-center items-center">
      ...
      <div className="flex flex-col text-4xl hover:text-[48px] sm:text-7xl sm:hover:text-[84px] transition-all duration-500 items-center justify-center font-bold z-20">
        <span className="">Шинэчлэгдсэн</span>
        <span className="text-[#aaf082] ">Ардкойн 3.0</span>
        <div className="flex items-center mt-5 text-base sm:text-2xl font-normal rounded-lg border-[#223e42] border-[1px] px-2 sm:px-3 py-1 sm:py-2 bg-white/5">
